...
papermill 1_downloading_data.ipynb output/Birmingham/Birmingham_1_downloading_data.ipynb -p local_crs 4326 -p place Birmingham -p lat 52.47790683186595 -p lng -1.8999014571831943 -p country UK -p crs 4326 -p radius 20
...
tail -f slurm-$Birmingham_SLURM_JOB_ID.out &
#------------------------------------------------------
