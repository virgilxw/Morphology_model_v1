...
#
# Job name
#SBATCH --job-name=London_OS_morph
#
# Output file
#SBATCH --output=London_OS-slurm-%j.out
...
papermill 1_ordanance_survey.ipynb ../output/London_OS/London_OS_1_ordanance_survey.ipynb -p local_crs 27700 -p place London_OS -p lat 51.507222 -p lng -0.1275 -p country UK -p crs 4326 -p radius 40
status=$?
