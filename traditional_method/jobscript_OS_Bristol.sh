...
papermill 2_tessellation.ipynb ../output/Bristol_OS/Bristol_2_tessellation.ipynb -p local_crs 27700 -p place Bristol_OS -p lat 51.453611 -p lng -2.5975 -p country UK -p crs 4326 -p radius 20
status=$?
