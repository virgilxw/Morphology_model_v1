...
#
# Job name
#SBATCH --job-name=test_OS_morph
#
# Output file
#SBATCH --output=test_OS-slurm-%j.out
...
papermill 1_ordanance_survey.ipynb ../output/test_OS/test_OS_1_ordanance_survey.ipynb -p local_crs 27700 -p place test_OS -p lat 55.86421405612109 -p lng -4.251846930489373 -p country UK -p crs 4326 -p radius 1
status=$?
