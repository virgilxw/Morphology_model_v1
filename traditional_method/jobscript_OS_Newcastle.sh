...
papermill 2_tessellation.ipynb ../output/Newcastle_OS/Newcastle_2_tessellation.ipynb -p local_crs 27700 -p place Newcastle_OS -p lat 54.98 -p lng -1.61 -p country UK -p crs 4326 -p radius 20
status=$?
