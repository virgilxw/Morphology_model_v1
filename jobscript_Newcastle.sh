...
papermill 1_downloading_data.ipynb output/Newcastle/Newcastle_1_downloading_data.ipynb -p local_crs 4326 -p place Newcastle -p lat 54.98 -p lng -1.61 -p country UK -p crs 4326 -p radius 20
...
tail -f slurm-$Newcastle_SLURM_JOB_ID.out &
#------------------------------------------------------
