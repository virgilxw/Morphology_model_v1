...
papermill 3_supercomp_morph.ipynb output/Newcastle_3_supercomp_morph.ipynb -p local_crs 3414 -p place Newcastle -p lat 54.98 -p lng -1.61 -p crs 4326 -p local_crs 27700
