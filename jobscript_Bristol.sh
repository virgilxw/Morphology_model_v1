...
papermill 3_supercomp_morph.ipynb output/Bristol_3_supercomp_morph.ipynb -p local_crs 3414 -p place Bristol -p lat 51.453611 -p lng -2.5975 -p crs 4326 -p local_crs 27700
