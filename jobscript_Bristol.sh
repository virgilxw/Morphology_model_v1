...
papermill 4_aggregation.ipynb output/Bristol_4_aggregation.ipynb -p local_crs 4326 -p place Bristol -p lat 51.453611 -p lng -2.5975 -p country {country} -p crs 4326
