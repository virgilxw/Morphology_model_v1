...
#
# Output file
#SBATCH --output=London-slurm-%j.out
...
papermill 3_supercomp_morph.ipynb ../output/London/London_3_supercomp_morph.ipynb -p local_crs 27700 -p place London -p lat 51.507222 -p lng -0.1275 -p country UK -p crs 4326 -p radius 40
status=$?
