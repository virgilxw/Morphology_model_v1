...
#
# Job name
#SBATCH --job-name=Manchester_p4_morph
#
# Output file
#SBATCH --output=Manchester_p4_-slurm-%j.out
...
papermill 4_network.ipynb ../output/Manchester/Manchester_4_network.ipynb -p local_crs 27700 -p place Manchester -p lat 53.479444 -p lng -2.245278 -p country UK -p crs 4326 -p radius 20
status=$?
