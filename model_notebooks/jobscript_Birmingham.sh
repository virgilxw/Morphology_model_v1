...
#
# Output file
#SBATCH --output=Birmingham-slurm-%j.out
...
papermill 3_supercomp_morph.ipynb ../output/Birmingham/Birmingham_3_supercomp_morph.ipynb -p local_crs 27700 -p place Birmingham -p lat 52.48 -p lng -1.9025 -p country UK -p crs 4326 -p radius 20
status=$?
