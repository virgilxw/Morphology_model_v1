...
papermill 3_supercomp_morph.ipynb ../output/test/test_3_supercomp_morph.ipynb -p local_crs 27700 -p place test -p lat 55.86421405612109 -p lng -4.251846930489373 -p country UK -p crs 4326 -p radius 1
status=$?
