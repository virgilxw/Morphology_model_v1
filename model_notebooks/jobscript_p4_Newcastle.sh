...
#
# Job name
#SBATCH --job-name=Newcastle_p4_morph
#
# Output file
#SBATCH --output=Newcastle_p4_-slurm-%j.out
...
papermill 4_network.ipynb ../output/Newcastle/Newcastle_4_network.ipynb -p local_crs 27700 -p place Newcastle -p lat 54.98 -p lng -1.61 -p country UK -p crs 4326 -p radius 20
status=$?
