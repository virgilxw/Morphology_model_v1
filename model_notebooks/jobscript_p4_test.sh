...
#
# Job name
#SBATCH --job-name=test_p4_morph
#
# Output file
#SBATCH --output=test_p4_-slurm-%j.out
...
papermill 4_network.ipynb ../output/test/test_4_network.ipynb -p local_crs 27700 -p place test -p lat 55.86421405612109 -p lng -4.251846930489373 -p country UK -p crs 4326 -p radius 1
status=$?
