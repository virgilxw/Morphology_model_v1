...
papermill 3_supercomp_morph.ipynb ../output/Milton_Keynes/Milton_Keynes_3_supercomp_morph.ipynb -p local_crs 27700 -p place Milton_Keynes -p lat 52.04 -p lng -0.76 -p country UK -p crs 4326 -p radius 20
status=$?
