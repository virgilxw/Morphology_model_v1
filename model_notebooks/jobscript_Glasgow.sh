...
#
# Output file
#SBATCH --output=Glasgow-slurm-%j.out
...
papermill 3_supercomp_morph.ipynb ../output/Glasgow/Glasgow_3_supercomp_morph.ipynb -p local_crs 27700 -p place Glasgow -p lat 55.86421405612109 -p lng -4.251846930489373 -p country UK -p crs 4326 -p radius 20
status=$?
