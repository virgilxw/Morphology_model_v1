...
#
# Job name
#SBATCH --job-name=London_p4_morph
#
# Output file
#SBATCH --output=London_p4_-slurm-%j.out
...
papermill 4_network.ipynb ../output/London/London_4_network.ipynb -p local_crs 27700 -p place London -p lat 51.507222 -p lng -0.1275 -p country UK -p crs 4326 -p radius 40
status=$?
