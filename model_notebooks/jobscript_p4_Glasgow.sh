...
#
# Job name
#SBATCH --job-name=Glasgow_p4_morph
#
# Output file
#SBATCH --output=Glasgow_p4_-slurm-%j.out
...
papermill 4_network.ipynb ../output/Glasgow/Glasgow_4_network.ipynb -p local_crs 27700 -p place Glasgow -p lat 55.86421405612109 -p lng -4.251846930489373 -p country UK -p crs 4326 -p radius 20
status=$?
