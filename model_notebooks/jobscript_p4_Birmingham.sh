...
#
# Job name
#SBATCH --job-name=Birmingham_p4_morph
#
# Output file
#SBATCH --output=Birmingham_p4_-slurm-%j.out
...
papermill 4_network.ipynb ../output/Birmingham/Birmingham_4_network.ipynb -p local_crs 27700 -p place Birmingham -p lat 52.48 -p lng -1.9025 -p country UK -p crs 4326 -p radius 20
status=$?
