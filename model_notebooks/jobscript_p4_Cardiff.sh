...
#
# Job name
#SBATCH --job-name=Cardiff_p4_morph
#
# Output file
#SBATCH --output=Cardiff_p4_-slurm-%j.out
...
papermill 4_network.ipynb ../output/Cardiff/Cardiff_4_network.ipynb -p local_crs 27700 -p place Cardiff -p lat 51.454514 -p lng -2.58791 -p country UK -p crs 4326 -p radius 20
status=$?
