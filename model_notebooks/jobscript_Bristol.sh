...
#
# Output file
#SBATCH --output=Bristol-slurm-%j.out
...
papermill 3_supercomp_morph.ipynb ../output/Bristol/Bristol_3_supercomp_morph.ipynb -p local_crs 27700 -p place Bristol -p lat 51.453611 -p lng -2.5975 -p country UK -p crs 4326 -p radius 20
status=$?
