...
#
# Output file
#SBATCH --output=Manchester-slurm-%j.out
...
papermill 3_supercomp_morph.ipynb ../output/Manchester/Manchester_3_supercomp_morph.ipynb -p local_crs 27700 -p place Manchester -p lat 53.479444 -p lng -2.245278 -p country UK -p crs 4326 -p radius 20
status=$?
