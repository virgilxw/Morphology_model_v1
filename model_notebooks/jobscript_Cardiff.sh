...
#
# Output file
#SBATCH --output=Cardiff-slurm-%j.out
...
papermill 3_supercomp_morph.ipynb ../output/Cardiff/Cardiff_3_supercomp_morph.ipynb -p local_crs 27700 -p place Cardiff -p lat 51.454514 -p lng -2.58791 -p country UK -p crs 4326 -p radius 20
status=$?
