...
papermill 2_tessellation.ipynb output/london_2_tessellation-executed.ipynb -p local_crs 27700 -p place london -p lat 51.51338978675002 -p lng -0.08976010193313122 -p crs 4326

papermill 4_supercomp_morph.ipynb output/london_4_supercomp_morph.ipynb -p local_crs 27700 -p place london -p lat 51.51338978675002 -p lng -0.08976010193313122 -p crs 4326
