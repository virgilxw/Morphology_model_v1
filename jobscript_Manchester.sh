...
papermill 4_aggregation.ipynb output/Manchester_4_aggregation.ipynb -p local_crs 4326 -p place Manchester -p lat 53.483959 -p lng -2.244644 -p country {country} -p crs 4326
