...
papermill 3_supercomp_morph.ipynb output/Manchester_3_supercomp_morph.ipynb -p local_crs 3414 -p place Manchester -p lat 53.483959 -p lng -2.244644 -p crs 4326 -p local_crs 27700
