...
papermill 4_aggregation.ipynb output/glasgow_4_aggregation.ipynb -p local_crs 4326 -p place glasgow -p lat 55.86421405612109 -p lng -4.251846930489373 -p country {country} -p crs 4326
